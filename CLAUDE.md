...
8. **文档去 AI 味**：新增或修改任何中文文档（README / AUTHOR / `思考与学习/` 等）后，按本仓库根目录 `SKILL.md`（humanizer 技能）过一遍，去掉 AI 写作痕迹（装饰 emoji、滥用加粗、三连排比、空泛拔高、套话填充、英文式破折号），保留代码 / 公式 / 表格和面向小白的讲故事风格。这是求职项目，文档要像懂行的人写的。
